                    ...
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('backend/subcategoryimages/' . $subcat->image) }}" alt=""
                                    height="80"></a>
                        </figure>
                        <h6><a href="shop-grid-right.html">{{ $subcat->subCatName }}</a></h6>
                        <span>
                            @php

                                $allitems = Items::where('item_code',$subcat->id)->get();
                            @endphp
