                    ...
                    <div class="table-responsive shopping-summery">
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                ...
                                <form action="{{Route('cartupdate',$item->id)}}" method="POST">
                                    @csrf
                                <tr class="pt-30">
                                    ...
                                    <td class="image product-thumbnail pt-40"><img src="{{asset('backend/items/'.$item->attributes->pic)}}" alt="#"></td>
                                    ...
                                    <td class="text-center detail-info" data-title="Stock">
                                        <div class="detail-extralink mr-15">
                                            <div class="detail-qty border radius">
                                                ...
                                                <input class="qty-val" type="number" name="qnt" value="{{$item->quantity}}" >
                                    ...
                                    <td class="action text-center" data-title="Remove"><button type="submit" class="btn btn-sm"><i class="fi-rs-edit"></i></button></td>
                                    <td class="action text-center" data-title="Remove"><a href="{{Route('deleteitem',$item->id)}}" class="text-body"><i class="fi-rs-trash"></i></a></td>
                                </tr>
                            </form>
                                @endforeach
