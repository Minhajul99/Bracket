                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-fr.png"
                                                alt="">Français</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-dt.png"
                                                alt="">Deutsch</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-ru.png"
                                                alt="">Pусский</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a href="shop-compare.html">
                                    <img class="svgInject" alt="Nest"
                                        src="{{ asset('frontend') }}/imgs/theme/icons/icon-compare.svg">
                            ...
                            <div class="header-action-icon-2">
                                <a href="page-account.html">
                                    <img class="svgInject" alt="Nest"
                                        src="{{ asset('frontend') }}/imgs/theme/icons/icon-user.svg">
                                </a>
                                ...
                                <ul>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-1.svg"
                                                alt="">Milks and Dairies</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-2.svg"
                                                alt="">Clothing & beauty</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-3.svg"
                                                alt="">Pet Foods & Toy</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-4.svg"
                                                alt="">Baking material</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-5.svg"
                                                alt="">Fresh Fruit</a>
                                    </li>
                                </ul>
                                <ul class="end">
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-6.svg"
                                                alt="">Wines & Drinks</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-7.svg"
                                                alt="">Fresh Seafood</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-8.svg"
                                                alt="">Fast food</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-9.svg"
                                                alt="">Vegetables</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('frontend') }}/imgs/theme/icons/category-10.svg"
                            ...
                            <div class="more_slide_open" style="display: none">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('frontend') }}/imgs/theme/icons/icon-1.svg"
                                                    alt="">Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                    ...
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('frontend') }}/imgs/theme/icons/icon-3.svg"
                                                    alt="">Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('frontend') }}/imgs/theme/icons/icon-4.svg"
                                                    alt="">Fresh Seafood</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <nav>
                            <ul>
                                <li class="hot-deals"><img
                                        src="{{ asset('frontend') }}/imgs/theme/icons/icon-hot.svg"
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        @foreach ($allcats as $allcat)
                                            <li>
                                                <a href="shop-grid-right.html">{{ $allcat->name }}<i class="fi-rs-angle-right"></i></a>
                                                <ul class="level-menu">
                                                    @php

                                                        $subcats = Subcategory::where('catId', $allcat->id)->get();
                                                    @endphp
                                                     @foreach ($subcats as $subcat)
                                                    <li><a href="shop-product-right.html">{{ $subcat->subCatName }}</a>
                                                    @endforeach
                                                    </li>
                                                </ul>
                                            </li>
