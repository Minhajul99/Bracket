                        ...
                        <tbody>
                            ...
                            @foreach ($subcat as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->des }}</td>
                                    <td><img height="80" src="{{ asset('backend/subcategoryimages/' . $data->image) }}"
                                            alt=""></td>
                                    <td>
                                        @if ($data->status == 1)
                                    ...
                                    <td>
                                        <a href="{{ Route('subcategory.edit', $data->id) }}" class="btn btn-sm btn-info"> <i
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Confirmation Massage
                                                </h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ Route('subcategory.delete', $data->id) }}" type="button"
